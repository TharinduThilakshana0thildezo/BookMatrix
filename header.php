...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom shadow-sm">
            <div class="container">
                <a class="navbar-brand fw-bold" href="index.php">LibraryOS</a>
                ...
                <div class="collapse navbar-collapse" id="publicNav">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="search_book.php">Search</a></li>
                        <li class="nav-item"><a class="nav-link" href="issue_book_details.php">Issue History</a></li>
                        <li class="nav-item"><a class="nav-link" href="profile.php">Profile</a></li>
                    </ul>
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        <?php if(is_user_login()) { ?>
                            <li class="nav-item"><span class="nav-link text-muted">ID: <?php echo $_SESSION['user_id']; ?></span></li>
